...
export class Service {
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/instructors/' + id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    update(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/update_instructors',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    update2(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/history_educate',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    update3(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/history_work',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    update4(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/history_training',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    update5(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/current_position',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    delete2(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/history_educate/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }

    delete3(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/history_work/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }

    delete4(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/history_training/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }

    delete5(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/current_position/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/instructors_page',
