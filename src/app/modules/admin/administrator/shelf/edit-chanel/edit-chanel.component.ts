...
@Component({
    selector: 'edit-chanel',
    templateUrl: './edit-chanel.component.html',
    styleUrls: ['./edit-chanel.component.scss'],
    animations: fuseAnimations,
})
export class EditChanelComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        private _matDialogRef: MatDialogRef<EditChanelComponent>
    ) {
    ...
    ngOnInit(): void {
        ...
        this.formData.patchValue({
            ...
            floor_id: parseInt(this._data.data.floor_id),
